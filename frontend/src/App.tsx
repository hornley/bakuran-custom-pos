...
function SecondaryView({ view, loading, paymentRows, kitchenRows, deliveryRows, deliveryDrivers, deliveryBusy, tableRows, receipts, search, setSearch, onSearch, onRefresh, onSelect, onDeliveryAction, onStartDelivery }: { view: View; loading: boolean; paymentRows: Row[]; kitchenRows: Row[]; deliveryRows: Row[]; deliveryDrivers: Row[]; deliveryBusy: boolean; tableRows: Row[]; receipts: Row[]; search: string; setSearch: (value: string) => void; onSearch: () => void; onRefresh: () => void; onSelect: (order: Row) => void; onDeliveryAction: (deliveryId: number, action: DeliveryAction, body?: Row) => void; onStartDelivery: () => void }) {
